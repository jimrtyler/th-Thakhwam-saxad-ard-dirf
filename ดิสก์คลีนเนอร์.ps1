...
#GUI Variables
$FormTitleText = "ตัวล้างดิสก์โดย Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "เลือกดิสก์:"
$FreeSpaceLabelText = "พื้นที่ว่าง (กิกะไบต์): "
$TotalSpaceLabelText = "พื้นที่ทั้งหมด (กิกะไบต์): "
$JunkFoundLabelText = "ขยะที่พบ (กิกะไบต์):"
$CleanDiskBtnText = "ล้างดิสก์ *ลบไฟล์*"
$SpaceCleanedLabelText = "พื้นที่ว่าง (กิกะไบต์): "
$LogFileLabelText = "พบไฟล์บันทึก: $abcdefg"
$CreditLabelText = "สคริปต์โดย Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "พบไฟล์บันทึก"
$AnalyzingDriveText = "กำลังวิเคราะห์ไดรฟ์..."
$BrowsersAreRunningText = "เบราว์เซอร์กำลังทำงาน... แจ้งผู้ใช้..."
$PleaseCloseBrowsersText = "โปรดปิดเว็บเบราว์เซอร์ทั้งหมดแล้วลองใหม่อีกครั้ง"
$CleaningDriveText = "กำลังล้างไดรฟ์..."
